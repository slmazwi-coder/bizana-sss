...
// the Bizana defaults in storage.ts take effect immediately.
const DATA_VERSION = 'bizana-v2';
if (localStorage.getItem('data_version') !== DATA_VERSION) {
  Object.keys(localStorage)
    .filter(k => k.startsWith('admin_') || k.startsWith('mh_') || k.startsWith('jojo_') || k.startsWith('bizana_'))
