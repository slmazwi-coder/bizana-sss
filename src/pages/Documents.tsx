  ...
  return (
    <div className="py-16 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-[#7B1B2B] rounded-2xl shadow-lg p-6 mb-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-white">
          ...
          <a
            ...
            download
            className="inline-flex items-center gap-2 bg-[#D4AF37] text-[#7B1B2B] px-5 py-2.5 rounded-xl font-bold hover:bg-white transition-colors shrink-0"
          >
            ...
            filteredDocs.map((doc) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="p-3 bg-[#FDF9EC] text-[#7B1B2B] rounded-xl group-hover:bg-[#B8860B] group-hover:text-white transition-colors">
                    <FileText size={24} />
                  </div>
                  <div className="flex-grow">
                    ...
                    <button 
                      ...
                      className="flex items-center gap-2 text-[#7B1B2B] font-bold hover:underline"
                    >
