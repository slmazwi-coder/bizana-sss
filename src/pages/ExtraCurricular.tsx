...
const ProgramCard: React.FC<{ prog: any }> = ({ prog }) => (
  ...
  >
    <div className="aspect-video bg-[#FDF9EC] flex items-center justify-center relative">
      <prog.icon size={64} className="text-[#7B1B2B]/40" />
    ...
    <div className="p-6">
      <div className="flex items-center gap-2 mb-2">
        <span className={`text-xs font-bold uppercase tracking-wider px-2 py-0.5 rounded-full ${
          prog.category === 'Sport' ? 'bg-[#FFF3CC] text-[#7B1B2B]' : 
          prog.category === 'Academic' ? 'bg-[#FDF9EC] text-[#7B1B2B]' :
...
export const ExtraCurricular = () => {
  ...
  const accolades = [
    { title: "National SASCE Champ of Champs", year: "2025", category: "Culture" },
    { title: "Matric Pass Rate 93.5%", year: "2025", category: "Academic" },
    { title: "District Athletics Participation", year: "2025", category: "Sport" },
    { title: "Provincial Choir Competitions", year: "2024", category: "Culture" },
    { title: "District Netball Participation", year: "2024", category: "Sport" },
    { title: "Academic Excellence Awards", year: "2025", category: "Academic" },
  ];
    ...
    <div className="py-16 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-center text-xl text-gray-600 mb-16 max-w-3xl mx-auto">
          At Bizana SSS, we believe in a holistic education. Our extra-curricular programs are designed to discover and nurture the diverse talents of our learners.
        </p>

        {/* Sports */}
        <section className="mb-16">
          <h2 className="text-2xl font-bold text-[#7B1B2B] mb-8 flex items-center gap-3">
            <Dumbbell className="text-[#7B1B2B]" /> Sports
          </h2>
        ...
        <section className="mb-16">
          <h2 className="text-2xl font-bold text-[#7B1B2B] mb-8 flex items-center gap-3">
            <BookOpen className="text-[#7B1B2B]" /> Academic Extra-Curricular
          </h2>
        ...
        <section className="mb-24">
          <h2 className="text-2xl font-bold text-[#7B1B2B] mb-8 flex items-center gap-3">
            <Music className="text-[#7B1B2B]" /> Arts & Culture
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          <section>
            <h2 className="text-3xl font-bold text-[#7B1B2B] mb-8 flex items-center gap-3">
          ...
          <section>
            ...
            <div className="bg-[#D4AF37] rounded-3xl p-8 text-white">
              <p className="text-lg italic mb-8 text-[#FFF3CC]">
                "Recognizing those who have gone above and beyond in representing Bizana SSS at regional, provincial, and national levels."
              </p>
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#FFF3CC]">Provincial Athletics Representative</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-bold">[NAME]</p>
                    <p className="text-sm text-[#FFF3CC]">National SASCE Choir Participant</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-bold">[NAME]</p>
                    <p className="text-sm text-[#FFF3CC]">Matric Top Achiever</p>
                  </div>
                </div>
              </div>
            </div>
