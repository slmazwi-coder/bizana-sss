...
const inp =
  'border border-gray-300 rounded-lg px-3 py-2 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#D4AF37]/40 focus:border-[#7B1B2B] transition w-full bg-white';
...
const SectionHeading = ({ icon, title }: { icon: React.ReactNode; title: string }) => (
  <div className="flex items-center gap-2 pb-2 border-b border-gray-200 mb-4">
    <span className="text-[#7B1B2B]">{icon}</span>
  ...
  <div className="flex items-center gap-2">
    <div
      className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-black border-2 transition-all
        ${done   ? 'bg-[#D4AF37] border-[#7B1B2B] text-white'
        : active ? 'bg-white border-white text-[#7B1B2B]'
  ...
  if (submitted) {
    return (
      <div className="py-20 flex items-center justify-center min-h-[60vh]">
        ...
        >
          <div className="w-20 h-20 bg-[#FFF3CC] text-[#7B1B2B] rounded-full flex items-center justify-center mx-auto mb-6">
            <CheckCircle size={48} />
          </div>
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Application Submitted!</h2>
          <p className="text-gray-600 mb-8">
            Thank you for applying to Bizana Senior Secondary School. We have received your application and will be in contact shortly.
          </p>
  ...
  return (
    <div className="py-12 sm:py-16 bg-gray-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 bg-[#FDF9EC] border border-[#7B1B2B]/20 rounded-2xl p-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <div className="font-bold text-gray-900 flex items-center gap-2">
              <FileText size={18} className="text-[#7B1B2B]" /> Prefer a paper form?
            </div>
          ...
          <a
            ...
            download
            className="inline-flex items-center justify-center gap-2 shrink-0 bg-[#7B1B2B] text-[#D4AF37] px-5 py-2.5 rounded-xl text-sm font-bold hover:bg-[#540D1C] transition-colors"
          >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-5">
              <div>
                ...
                <p className="text-white/70 text-sm mt-1">
                  Bizana Senior Secondary School &nbsp;·&nbsp; ERF 762, Near St Patrick's Hospital, Bizana, 4800
                </p>
              </div>
              <div className="text-right text-sm text-white/70">
                <div>Tel: 071 891 7774 / 083 392 5640 / 039 251 0384</div>
                  ...
                  <>
                    ...
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        className="text-sm font-semibold text-[#7B1B2B] underline underline-offset-2"
                      >
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                {file && <div className="text-xs text-[#7B1B2B] truncate mt-0.5">{file.name}</div>}
                                {!file && <div className="text-xs text-gray-400 mt-0.5">No file chosen</div>}
                              </div>
                              <label className="shrink-0 text-xs font-bold text-[#7B1B2B] cursor-pointer hover:underline">
                                {file ? 'Change' : 'Upload'}
                                <input
                                  type="file"
                                  className="hidden"
                ...
                <div className="flex items-center justify-between pt-2 border-t border-gray-100">
                  ...
                  {step < 3 ? (
                    <button
                      type="button"
                      onClick={goNext}
                      className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-[#D4AF37] text-white text-sm font-bold hover:bg-[#B8860B]/90 transition shadow"
                    >
                    ...
                    <button
                      type="submit"
                      disabled={submitting}
                      className="inline-flex items-center gap-2 px-7 py-2.5 rounded-xl bg-[#D4AF37] text-white text-sm font-bold hover:bg-[#B8860B]/90 disabled:opacity-60 disabled:cursor-not-allowed transition shadow"
                    >
                      {submitting ? (
