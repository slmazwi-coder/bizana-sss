    ...
    <div className="py-12 sm:py-16 bg-white min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {activities.map((a) => (
            <div key={a.name} className="bg-gray-50 rounded-3xl border border-gray-100 p-7">
              <div className="flex items-center gap-3 mb-3">
                <div className="p-3 rounded-2xl bg-white border border-gray-200 text-[#7B1B2B]">
                  <a.icon size={22} />
                </div>
        ...
        <div className="mt-12 bg-[#FDF9EC] border border-[#D4AF37] rounded-3xl p-6 sm:p-7">
          <div className="text-sm font-black uppercase tracking-widest text-[#7B1B2B]">More activities</div>
