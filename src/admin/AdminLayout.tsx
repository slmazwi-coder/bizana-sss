...
export const AdminLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      <div className="bg-[#7B1B2B] text-white text-center py-1.5 text-xs font-bold uppercase tracking-widest shadow-sm">
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              ...
              <Link to="/admin" className="text-lg font-bold text-white flex items-center gap-2">
                ...
                />
                <span className="text-[#D4AF37]">Bizana</span> Staff Portal
              </Link>
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs whitespace-nowrap font-medium ${
                  isActive ? 'bg-[#7B1B2B] text-[#D4AF37]' : 'text-gray-400 bg-gray-700'
                }`}
              >
                <Icon size={14} />
                {tab.label}
