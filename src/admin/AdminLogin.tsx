    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
      <div className="bg-gray-800 rounded-2xl shadow-2xl p-8 w-full max-w-md border border-gray-700">
        ...
        <div className="text-center mb-8">
          <div className="w-16 h-16 bg-[#7B1B2B] rounded-full flex items-center justify-center mx-auto mb-4 border-2 border-[#D4AF37]">
            <Lock className="text-[#D4AF37]" size={28} />
          </div>
          <h1 className="text-2xl font-bold text-white">Staff Portal</h1>
          <p className="text-gray-400 text-sm mt-1">Bizana SSS Administration</p>
        </div>

        {setupMode ? (
          <div className="bg-[#7B1B2B]/10 border border-[#7B1B2B]/30 rounded-xl p-4 mb-6">
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <button
            type="submit"
            className="w-full bg-[#7B1B2B] text-[#D4AF37] py-3 rounded-xl font-bold hover:bg-[#540D1C] transition-colors"
          >
