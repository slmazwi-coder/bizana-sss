...
const SCHOOL_DATA_VERSION = 'bizana-sss-v2';
...
const defaultContact: ContactInfo = {
  address: "ERF 762, Near St Patrick's Hospital, Bizana, 4800\nPrivate Bag X616, Bizana, 4800",
...
const defaultActivities: Activity[] = [
  ...
  { id: '4', name: 'Choir', category: 'Culture', description: 'Award-winning choral programme competing at provincial and national SASCE level.', image: '' },
...
const defaultResults: Record<string, YearResults> = {
  '2025': {
    ...
    subjects: [
      ...
      { subject: 'Mathematics', rate: 79.8 },
      { subject: 'Mathematical Literacy', rate: 89 },
      { subject: 'Life Sciences', rate: 95.9 },
      { subject: 'Physical Sciences', rate: 90 },
      { subject: 'Agricultural Sciences', rate: 99 },
      { subject: 'Geography', rate: 94.5 },
      { subject: 'Tourism', rate: 100 },
      { subject: 'History', rate: 99.1 },
    ],
  },
  '2024': {
    overall: 0,
...
const ADMIN_USERS_KEY = 'bizana_admin_users';
const ADMIN_CURRENT_KEY = 'bizana_admin_current_user';
...
export async function seedAdminUsers(): Promise<void> {
  ...
  const age34Hash = await sha256('AgeBizana#26');
