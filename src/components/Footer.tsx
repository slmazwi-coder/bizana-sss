...
export const Footer = () => {
  ...
  return (
    <footer className="pt-12 pb-8 w-full" style={ { background: '#7B1B2B', borderTop: '4px solid #D4AF37' } }>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-10">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-3 mb-3">
              <div className="h-12 w-auto max-w-[5rem] shrink-0 rounded-xl overflow-hidden shadow-lg flex items-center justify-center bg-white px-1"
                style={ { border: '2px solid #D4AF37' } }>
                <img src="/bizana-logo.jpg" alt="Bizana SSS logo"
              ...
              <div>
                ...
                <p className="text-sm italic mt-0.5" style={ { color: 'rgba(212,175,55,0.65)' } }>
          ...
          <div>
            <h4 className="text-sm font-bold mb-4 pb-2 uppercase tracking-wide"
              style={ { color: '#D4AF37', borderBottom: '1px solid rgba(212,175,55,0.25)' } }>
              Contact Us
            </h4>
            <ul className="space-y-3 text-sm" style={ { color: 'rgba(212,175,55,0.8)' } }>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm" style={ { color: 'rgba(212,175,55,0.8)' } }>
        ...
        {/* Bottom bar */}
        <div className="pt-6 text-center text-xs" style={ { borderTop: '1px solid rgba(212,175,55,0.15)', color: 'rgba(212,175,55,0.5)' } }>
          <p>© {new Date().getFullYear()} Bizana Senior Secondary School. All Rights Reserved.</p>
          <Link to="/admin/login"
